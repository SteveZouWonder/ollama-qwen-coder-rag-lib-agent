...
如果检查通过，继续以下步骤。如果有问题，请参考 [安装和配置指南](docs/tutorials/02-installation.md) 与 [前置条件检查快速指南](docs/general/QUICK_START_CHECK.md)。
...
内容安全扫描器的详细说明请查看：[安全功能文档](docs/general/SECURITY_DOCUMENTATION.md)
