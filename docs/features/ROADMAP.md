...
| 中高 | F10 P1：~~真流式输出（Web token 事件 / CLI rich Live、可中断）~~ **P1-1 已完成 2026-09-09**；~~LLM 后端抽象层（Ollama / OpenAI 兼容，接入 vLLM / LM Studio）~~ **P1-2 已完成 2026-09-09**；RAG 评测集与基准脚本 | [F10](f10-hardening/) |
...
**最后更新**: 2026-09-09（F10 P0-1 / P0-2 / P1-1 / P1-2 完成）
