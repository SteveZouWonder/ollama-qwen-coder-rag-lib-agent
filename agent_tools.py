...
# RAG 工具
registry.register("query_knowledge_base", query_knowledge_base, "查询个人知识库（PDF、论文、笔记等文档）",
                  {"question": "查询问题(必填)"}, safe=True)
registry.register("add_to_knowledge_base", add_to_knowledge_base, "将文档（PDF/MD/TXT等）添加到知识库",
